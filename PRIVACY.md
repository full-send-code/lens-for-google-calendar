# Privacy Policy for Lens for Google Calendar
...
- **Extension logs**: When you choose to download support logs from the extension settings, console messages are captured locally
...
- **User-initiated only**: Logs are only exported when you explicitly click the "Download Logs" button in the extension settings
...
- **Support logs**: Extension logs are stored locally for troubleshooting and are automatically cleared after 24 hours
