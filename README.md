...
- **Support Logs**: Download anonymized logs for troubleshooting from the extension settings (privacy-focused with no external data transmission)
...
- **Download Logs**: Export extension logs from the extension settings for troubleshooting
  - Click the extension icon in the Chrome toolbar, then click "Download Logs"
  ...
  - Logs can be manually cleared using the "Clear Logs" button
